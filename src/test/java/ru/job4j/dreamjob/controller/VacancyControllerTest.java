...
public class VacancyControllerTest {
    ...
    @Test
    public void whenRequestVacancyByIdThenGetPageVacanciesOne() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
    ...
    @Test
    public void whenPostVacancyUpdateThenRedirectToVacanciesPage() throws IOException {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        var fileDto = new FileDto(testFile.getOriginalFilename(), testFile.getBytes());
        var vacancyArgumentCaptor = ArgumentCaptor.forClass(Vacancy.class);
        var fileDtoArgumentCaptor = ArgumentCaptor.forClass(FileDto.class);
    ...
    @Test
    public void whenGetDeleteVacancyThenDeletedAndRedirectToVacanciesPage() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
    ...
    @Test
    public void whenGetDeleteVacancyThenErrorPageWithMessage() {
        when(vacancyService.deleteById(anyInt())).thenReturn(false);

        var model = new ConcurrentModel();
        var view = vacancyController.delete(model, 7);
