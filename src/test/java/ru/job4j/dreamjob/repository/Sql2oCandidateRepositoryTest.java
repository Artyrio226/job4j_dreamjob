...
public class Sql2oCandidateRepositoryTest {
    ...
    public void whenUpdateThenGetUpdated() {
        ...
        var savedCandidate = sql2oCandidateRepository.findById(updatedVacancy.getId()).get();
        assertThat(isUpdated).isTrue();
        assertThat(savedCandidate).usingRecursiveComparison().isEqualTo(updatedVacancy);
    }
